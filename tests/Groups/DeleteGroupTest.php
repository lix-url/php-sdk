...
final class DeleteGroupTest extends TestCase
{
    // Testing the delete group request structure
    public function testRequestDeleteGroup(): void
    {
