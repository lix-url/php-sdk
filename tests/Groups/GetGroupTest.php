...
final class GetGroupTest extends TestCase
{
    ...
    // Testing the get group request structure
    public function testRequestGetGroup(): void
    {
        $mockHttpClient = self::getHttpClient();
        ...
        $client->groups()->get(1503);

        $requests = $mockHttpClient->getRequests();
        $this->assertCount(1, $requests);

        $this->assertSame('https://lix.li/api/1.0/groups/1503', (string) $requests[0]->getUri());
