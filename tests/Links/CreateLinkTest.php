...
final class CreateLinkTest extends TestCase
{
    ...
    // Testing the create link request structure
    public function testRequestCreateLink(): void
    {
        $mockHttpClient = self::getHttpClient();
